...
export const EXERCISE_MUSCLE_MAP: Record<string, string[]> = {
  // PUSH
  'push_bench_mach': ['chest'],
  'push_incline_mach': ['chest'],
  'push_dips': ['chest', 'triceps'],
  'push_shoulder_mach': ['shoulders'],
  ...
  'low_hip': ['glutes'],
  'low_goblet': ['quads', 'glutes'],
  'low_back_ext': ['back', 'glutes', 'hamstrings'],
